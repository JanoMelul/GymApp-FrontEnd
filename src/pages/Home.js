      ...
      <div className="w-full max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row items-center mt-8">
          ...
          <div className="md:w-1/2 order-1 p-4">
            <h2 className="text-3xl font-semibold text-gray-800 mb-4">Profesores</h2>
            <p>Conoce a nuestros expertos profesores que te guiarán en tu viaje de fitness.</p>
            <Link to="/profesores" className="mt-4 text-blue-500 hover:underline">Conocer Profesores</Link>
          </div>
        </div>
        <div className="flex flex-col md:flex-row items-center mt-8">
          <div className="md:w-1/2 p-4">
          ...
          <div className="md:w-1/2 p-4">
            ...
            <Link to="/sobre-nosotros" className="mt-4 text-blue-500 hover:underline">Acerca de Nosotros</Link>
          </div>
        </div>
        <div className="flex flex-col md:flex-row items-center mt-8">
          <div className="md:w-1/2 order-2 p-4">
          ...
          <div className="md-w-1/2 order-1 p-4">
            ...
            <Link to="/contacto" className="mt-4 text-blue-500 hover:underline">Contacto</Link>
          </div>
        </div>
      </div>
    </div>
